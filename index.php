...
if($filas) {
  header("location:user.php");
    ...
    <?php
    include("index.html");
    echo ('<script languaje="javascript">alert("Error al iniciar sesión Intentelo nuevamente!! ;-( ")');
  ?>
    <!-- <h1 class="bad">Error al iniciar sesión en Karmaland</h1>   -->
<!--    <script language="javascript">alert("Error al iniciar sesión Intentelo nuevamente!! ;-( ");</script>
 -->     <?php
 
  echo ('<script language="javascript">alert("Error al iniciar sesión Intentelo nuevamente!! ;-( ");</script>');
}
mysqli_free_result($resultado);
mysqli_close($conn);
//echo ('<script language="javascript">alert("Cerraste sesión exitosamente Adios!! ;-( ");</script>');